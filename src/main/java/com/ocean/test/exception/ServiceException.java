package com.ocean.test.exception;

import java.text.MessageFormat;
import java.util.MissingResourceException;

import com.ocean.framework.core.utils.PropertiesUtil;

/**
 * 业务异常基类. 带有错误代码与错误信息. 用户在生成异常时既可以直接赋予错误代码与错误信息. 也可以只赋予错误代码与错误信息参数.
 * 如ErrorCode=ORDER.LACK_INVENTORY ,errorArg=without EJB
 * HIHSOFT-SSO-000001={0} 系统出错，请与系统管理员联系。
 * 系统会从errors.properties中查出 HIHSOFT-000001 
 * 
 */
public class ServiceException extends RuntimeException {
	...
	public String getMessage() {
		...
		String message;
		try {
			message =(String)PropertiesUtil.getProperty(errorCode);
